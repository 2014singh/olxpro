# -*- coding: utf-8 -*-
# Generated by Django 1.11.17 on 2019-04-15 09:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bike_img', models.ImageField(blank=True, max_length=200, upload_to='bikeimg/%Y/%m/%d/')),
                ('currdata', models.DateField(max_length=100)),
                ('mobile', models.BigIntegerField()),
                ('address', models.CharField(max_length=300)),
                ('rel_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='testapp.UserRegistrationData')),
            ],
        ),
    ]
